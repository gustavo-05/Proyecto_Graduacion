              ...
              <input type="hidden" id="idColor" name="idColor" value="">
               <p class="text-danger">Campos obligatorios *</p>
                <div class="form-group">
                  ...
                  <input class="form-control valid validText" id="txtNombreColores" name="txtNombreColores" type="text" placeholder="Ingrese el color" required="">
                </div>
                <div class="form-group">
                  <label class="control-label">Descripción</label>
                  <textarea class="form-control valid validText" id="txtDescripciónColores" name="txtDescripciónColores" rows="2" placeholder="Opcional"></textarea>
                </div>

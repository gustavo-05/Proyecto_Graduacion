    ...
    class Productos extends Controllers
    {
        ...
        public function getProductos()
        {
            ...
            for($i=0; $i<count($arrData); $i++)
            {
                ...
                <button class="btn btn-outline-warning btnActualizarProducto" rl="'.$arrData[$i]['idProductos'].'" title="Actualizar">Actualizar</button>
                </div>';

                //boton eliminar
                $arrData[$i]['eliminar'] = '<div class="text-center">
                <button class="btn btn-outline-danger btnEliminarProducto" rl="'.$arrData[$i]['idProductos'].'" title="Eliminar">Eliminar</button>
                </div>';
            }
